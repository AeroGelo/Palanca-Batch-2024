...
scholars = {
    ...
    35: {'nickname': 'Miggy', 
        'description': '6’3, loves women, feminist',
        'section': '12 - RIGEL',
        'core': 'BIOLOGY CORE',
    ...
    64: {'nickname': 'Nico', 
        ...
        'core': 'PHYSICS CORE',
        'username': 'drosorio',
        'password': bcrypt_sha256.hash('chessmasterbetterthangelo123'),
    ...
    83: {'nickname': 'Andrei', 
        'description': 'Hi, guys! I’m Andrei Nicolei F. Uy, Future Thomas the Train Engine! Ang masasabi ko lang sa buhay ay, "Basta may tiyaga, may nilaga". Ug no, wala’y Guinness moabot HAHAHAHA And I, thank you!',
        'section': '12 - SIRIUS',
        'core': 'PHYSICS CORE',
        'username': 'afuy',
    ...
    87: {'nickname': 'Henry', 
        'description': 'tambay sa gym ug makerspace',
        'section': '12 - POLLUX',
        'core': 'PHYSICS CORE',
        'username': 'htyap',
